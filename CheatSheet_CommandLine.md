...
| Nếu gặp tình huống... | Hãy dùng lệnh này | Giải thích |
| :--- | :--- | :--- |
...
| Nếu gặp tình huống... | Hãy dùng lệnh này | Giải thích nhanh |
| :--- | :--- | :--- |
...
| **Tắt một tiến trình đang bị treo** | `kill -9 [PID]` | "Giết" ngay lập tức tiến trình cứng đầu. |
...
| **Tìm và đổi hàng loạt Port trong file**| `sed -i 's/22/2222/g' config.conf` | Đổi toàn bộ số 22 thành 2222 cực nhanh. |
